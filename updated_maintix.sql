...
INSERT INTO `ticket` (`ticket_id`, `employee_id`, `subject`, `lab_room`, `priority`, `description`, `attachment_filename`, `upload_note`, `status`, `date_submitted`, `date_resolved`, `date_updated`, `notification_read`) VALUES
(1, 2, NULL, 'ITS 201', 'normal', 'Issues: Slow Performance', NULL, '', 'Pending', '2025-10-26 20:51:21', NULL, '2025-10-26 12:53:11', 0),
(2, 2, NULL, 'PTC 304', 'high', 'Issues: CPU Damaged / Boot Error', '68fe19635bed1.png', 'PC-050', 'Pending', '2025-10-26 20:51:47', NULL, '2025-10-26 12:53:11', 0);
...
(1, 'Main', 'Administrator', 'UP-11-111-P', '09123456789', 'CITE', 'admin.maintix.up@phinmaed.com', '$2y$10$qEEWY8eDoOlq3zAE.MiSWe1bg1P5XuhsORR8shDYTNZ5Q/65dbouG', 'admin', 'active'),
(2, 'Keziah', 'Garcia', 'UP-32-105-P', '09941963233', 'CITE', 'kggarcia.up@phinmaed.com', '$2y$10$CAcSrAK6LwN.DjgahSzxPOf5tliu1LH9pWhXop9jEWYwt1h.lZWPm', 'requester', 'active'),
(3, 'Arlry', 'Baldonasa', 'UP-22-543-P', '09941964244', 'CEA', 'arbaldonasa.up@phinmaed.com', '$2y$10$qXe8MscAxCcLk7KPOKOjlel9cYFm5BgUj9zzykhijPW3jTKskLmSe', 'admin', 'active'),
(4, 'Cedrick Rhae', 'Alcaide', 'UP-76-543-P', '09876543210', 'CITE', 'caalcaide.up@phinmaed.com', '$2y$10$Mg3cr3kSxrXg2ZP2D9QPBONB3wwZTee6wzMIxo6ephouwGvm3Yh8q', 'requester', 'active'),
(5, 'Jan Lewis', 'Agas', 'UP-23-123-P', '09129834765', 'CITE', 'jtagas.up@phinmaed.com', '$2y$10$zzQKt748wbGRU2BRad3VE.ThYPrXNbZ3epGCUtkp4WWzOwNvUZlay', 'requester', 'active'),
(6, 'Mariam', 'Magalong', 'UP-25-123-P', '09988776655', 'CEA', 'mdmagalong.up@phinmaed.com', '$2y$10$6Zcgiqd2.QwAdZwHLBOEGOXIv7Z5ZPgIdhs.gQmgJwWnxlsR/aodK', 'requester', 'active');
...
ALTER TABLE `ticket`
  ...
  ADD KEY `fk_ticket_employee_id` (`employee_id`);
...
--
ALTER TABLE `request`
  ADD CONSTRAINT `fk_request_concern_id` FOREIGN KEY (`concern_id`) REFERENCES `concern` (`concern_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_request_ticket_id` FOREIGN KEY (`ticket_id`) REFERENCES `ticket` (`ticket_id`) ON UPDATE CASCADE;

--
-- Constraints for table `ticket`
--
ALTER TABLE `ticket`
  ADD CONSTRAINT `fk_ticket_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `user_info` (`employee_id`) ON UPDATE CASCADE;
COMMIT;
